...
// Correctifs couleurs pour Neolao ?>
.info {
	top: <?php echo $hvid + 12;?>px;
	left: 52px;
	width: <?php echo $wvid - 98;?>px;
	height: 16px;
	color: #ffffff;
	font-weight: bold;
}
.titleon, .titleoff {color : #ffffff;	font-weight: bold;}

<?php 
if (ereg("MSIE 6", getenv("HTTP_USER_AGENT")) && !($hplay<125)) {// SI IE 6 ?>
.titleon, .titleoff {background-color : #000000;}
<?php } ?>
