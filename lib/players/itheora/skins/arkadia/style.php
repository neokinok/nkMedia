...
.big_Ogv, .big_Ogg { background : url(<?php echo $spath; ?>icones/big_Ogg.png) no-repeat; }
...
.Ogv, .Ogg { background : url(<?php echo $spath; ?>icones/Ogg.png) no-repeat; }
...
// Correctifs couleurs pour Arkadia ?>

a:link, a:visited {color:#254c7a;}
a:hover {color:#68b063;}
h1, .playlist_title, h1 a {color : #254c7a; }

.codebox {background-color: #224b77;}
.code {color: #eae0ce; background : transparent;}

.msg_playlist, .msg_error, .msg_share, 
.msg_download, .msg_options, .msg_info {
